...
namespace App\Livewire\Components\Products\Form;
...
class Edit extends Component implements HasForms
{
                        ...
                        Forms\Components\Section::make(__('shopper::pages/products.product_associations'))
                            ->schema([
                                ...
                                Forms\Components\Select::make('category_id')
                                    ->label(__('shopper::pages/categories.menu'))
                                    ->relationship('categories', 'name', fn (Builder $query) => $query->where('is_enabled', true))
                                    ->searchable()
                                    ->preload()
                                    ->visible(Feature::enabled('category')),
    ...
    public function render(): View
    {
        ...
        return view('livewire.components.products.forms.edit');
